    ...
    <Card className="shadow-sm">
      ...
      <CardContent className="space-y-2">
        <div className="flex gap-2 flex-wrap">
          <Button onClick={() => { setUseSample(true); setPriceCSV(""); setFlowCSV(""); }}>
            <Download className="w-4 h-4 mr-2"/>샘플 로드
          </Button>
          <Button variant="secondary" onClick={() => { setUseSample(false); }}>
            <Upload className="w-4 h-4 mr-2"/>내 CSV 사용
          </Button>
